...
public class RockScissorPaper {
	...
	// 멤버변수가 필요하면 작성하세요.
	public static String [] arRSP = {"가위","바위","보"};
	...
	public static void showMenu() {
		System.out.println("--------------------------------------");
		System.out.println("다음 중 하나를 선택 하세요 :\n" 
		+ "1] 가위\n" 
		+ "2] 바위\n"
		+ "3] 보\n" + "0] 종료 ");
		System.out.println("--------------------------------------");
	...
	public static void displayChoice(int user, int com) {
		System.out.println("1) user : " + getHandType(user - 1));
		System.out.println("2) com : " + getHandType(com - 1));
