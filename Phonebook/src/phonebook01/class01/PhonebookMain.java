...
//
//	public static void main(String[] args) {
//		PhonbookMain app = new PhonbookMain();
//		app.init(); // 초기화
//		app.run(); // 실행
//		app.exit(); // 종료
//
...
//	// 전화번호부 입력
//	public void insertPhoneBook() {
//		// TODO		// 집가서 교수님꺼 보고 집어넣기
//		
//		for (int i = 0; i < bookData.length; i++) {
//			if(bookData[i] == null) {
//					System.out.println("이름, 번호, 이메일을 차례대로 입력하세요");
//					bookData[i] = new PhonebookModel(sc.next(), sc.next(), sc.next());
////					System.out.println("이름 :");
////					bookData[i].setName(sc.next());
////					System.out.println("전화 :");
////					bookData[i].setPhoneNum(sc.next());
////					System.out.println("이메일 :");
////					bookData[i].setEmail(sc.next());
//					System.out.println();
//				}else {
