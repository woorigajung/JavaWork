...
public class DB05Main implements Query {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 쿼리연산(들) 수행
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '1번쨰', SYSDATE)");
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '2번쨰', SYSDATE)");
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '3번쨰', SYSDATE)");
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '4번쨰', SYSDATE)");
