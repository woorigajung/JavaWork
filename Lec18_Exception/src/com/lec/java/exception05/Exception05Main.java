...
public class Exception05Main {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("#2 try{} 시작");		// 오류난 부분 다음은 실행이 안된다 죽는다
													// catch문에 그 오류가 있다면 catch 문 실행 
													// 프로그램이 죽어도
													// 마지막으로 fianlly 문 실행 (무조건 실행)
		...
		System.out.println("#6 try{} 종료 후");		// 오류나면 try ~ catch 문 끝나도 실행되지 않는다
