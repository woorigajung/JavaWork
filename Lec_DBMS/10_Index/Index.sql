...
-- 사원의 인덱스
SELECT empno, ROWid  FROM t_emp; -- ROWID, ROW INSERT 될떄마따 부여됨, SELECT 시 기본적으로 참조
...
INSERT INTO t_dept2 VALUES(9101, '임시장', 1006, '부산지사');
...
CREATE INDEX idx_prof_pay_fpi ON t_professor(pay + 100);
