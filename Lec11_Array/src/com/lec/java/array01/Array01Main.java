...
public class Array01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("국어0 : " + korean[1]);
		System.out.println("국어0 : " + korean[2]);

		// korean[3] = 60; // ArrayIndexOutOfBoundsException 발생
		...
		// 선언과 동시에 초기화
		int [] english1 = new int[] {30, 20,30};
		for (int i = 0; i < english1.length; i++) {
			System.out.println("영어" + i + " : " + english1[i]);
