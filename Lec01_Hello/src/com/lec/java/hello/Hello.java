...
public class Hello {
	...
	// https://www.youtube.com/watch?v=Ldb6ixbKoUU
	
	    public int solution(String skill, String[] skill_trees) {
	    	TreeMap<String, Integer> skillTree = new TreeMap<String, Integer>();
	    	
	    	for (int i = 0; i < skill_trees.length; i++) {
				skillTree.put(skill_trees[i], i);
			}
	    	
	    	for (int i = 0; i < skill.length(); i++) {
	    		skillTree.get(skill.charAt(i));
